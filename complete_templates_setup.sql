-- Complete Templates Setup - Run this entire script in Supabase SQL Editor
-- This will create the table, functions, and populate all template data
...
-- =====================================================
-- 4. RESET STATISTICS WITH REALISTIC VALUES
-- =====================================================
...
-- Check templates were created successfully
SELECT 
