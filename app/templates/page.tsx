      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-12">
          <div className="bg-white rounded-sm p-6 text-center shadow-sm">
            <div className="text-2xl font-bold text-blue-600 mb-1">{templates.length}</div>
            ...
            <Card key={template.id} className="hover:shadow-sm transition-shadow">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button size="sm" className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-sans">
                    Use Template
                  </Button>
                </div>
              </CardContent>
        ...
        {/* CTA Section */}
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-purple-700 rounded-sm p-8 text-center text-white">
          ...
          <Button className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-3 text-lg font-sans">
