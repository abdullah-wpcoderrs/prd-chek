      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-8 mb-16">
          <div className="text-center mb-6 md:mb-8 px-4">
            ...
            <p className="text-[13px] md:text-base text-gray-700 font-sans max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 px-4">
            <div className="text-center">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-blue-500 text-white rounded-xl flex items-center justify-center mx-auto mb-2 md:mb-3">
                <Sparkles className="w-5 h-5 md:w-6 md:h-6" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-1.5 md:mb-2 font-sans text-[13px] md:text-base">Context Engineering</h3>
              <p className="text-[13px] md:text-sm text-gray-600 font-sans">
                Documentation structured specifically for AI development tools and cross-functional team alignment
              </p>
            </div>
            
            <div className="text-center">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-green-500 text-white rounded-xl flex items-center justify-center mx-auto mb-2 md:mb-3">
                <Users className="w-5 h-5 md:w-6 md:h-6" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-1.5 md:mb-2 font-sans text-[13px] md:text-base">Technical Precision</h3>
              <p className="text-[13px] md:text-sm text-gray-600 font-sans">
            ...
            <div className="text-center">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-purple-500 text-white rounded-xl flex items-center justify-center mx-auto mb-2 md:mb-3">
                <Code className="w-5 h-5 md:w-6 md:h-6" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-1.5 md:mb-2 font-sans text-[13px] md:text-base">Development Ready</h3>
              <p className="text-[13px] md:text-sm text-gray-600 font-sans">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-[16px] md:text-2xl font-bold text-gray-900 font-sans">Discovery & Research</h3>
              <div className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-[13px] md:text-sm font-medium">
                Foundation
              </div>
            </div>
            <Card className="border-2 border-blue-100 hover:border-blue-200 transition-colors">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-[16px] md:text-lg font-semibold text-gray-900 mb-2 font-sans">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-[16px] md:text-2xl font-bold text-gray-900 font-sans">Vision & Strategy</h3>
              <div className="bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-[13px] md:text-sm font-medium">
                Direction
              </div>
            </div>
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-[16px] md:text-2xl font-bold text-gray-900 font-sans">Requirements & Planning</h3>
              <div className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-[13px] md:text-sm font-medium">
                Implementation
              </div>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Card className="border-2 border-green-100 hover:border-green-200 transition-colors">
                <CardContent className="p-4 text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-1 font-sans text-[13px]">
                    Product Requirements Document (PRD)
                  </h4>
                  <p className="text-gray-600 text-[13px] font-sans mb-2">
          ...
          <div className="bg-gray-900 text-white rounded-2xl p-8 mb-12">
            <h3 className="text-lg md:text-2xl font-bold mb-4 md:mb-6 font-sans text-center px-4">
              Built for Technical Product Management
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 px-4">
              <div>
                <h4 className="font-semibold mb-2 md:mb-3 font-sans text-base md:text-lg">For Product Managers</h4>
              ...
              <div>
                <h4 className="font-semibold mb-2 md:mb-3 font-sans text-base md:text-lg">For Context Engineers</h4>
                <div className="space-y-1.5 md:space-y-2">
                  <div className="flex items-start gap-2 text-xs md:text-sm">
                    <CheckCircle className="w-3.5 h-3.5 md:w-4 md:h-4 text-blue-400 flex-shrink-0 mt-0.5" />
